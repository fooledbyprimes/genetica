...
public class SAgui extends Frame implements ActionListener {
    ...
    TextField tstopedit;
    Label temperatureLbl, alpha, beta, iterations;
    Label stopTempLbl;
    Button openfile;
    Button process;
    ...
    public SAgui() { this(null, null); }
    public SAgui(String filename) { this(null, filename); }
    public SAgui(String directory, String filename) {
        ...
        annealing = new AnnealingSimulator(adjList);
        ...
        c.gridy=6; c.gridx=0; controls.add(temperatureLbl,c);
                   c.gridx=1; controls.add(tedit,c); 
        c.gridy=7; c.gridx=0; controls.add(stopTempLbl,c);
                   c.gridx=1; controls.add(tstopedit,c); 
        c.gridy=8; c.gridx=0; controls.add(alpha,c);
                   c.gridx=1; controls.add(aedit,c); 
        c.gridy=9; c.gridx=0; controls.add(beta,c);
                   c.gridx=1; controls.add(bedit,c); 
        c.gridy=10; c.gridx=0; controls.add(iterations,c);
    ...
    public void setFile(String directory, String filename) {
        ...
        try {
            ...
            this.setTitle("Independent Set Simulated Annealing");
    ...
    public void actionPerformed(ActionEvent e) {
		...
		if ( setInput() ) {
		    annealing.init(adjList);
		    setSAparams();
		    solution = annealing.getSolution();
		    ...
		    //FLAG ERROR  
		    textarea.append("Bad Graph Descrip: "+currentFile);
		    start.setEnabled(false);
		};
	    }
